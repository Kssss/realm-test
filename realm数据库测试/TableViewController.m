...
- (void)viewDidLoad
{
    ...
    for (NSString *section in self.sectionTitles) {
        ...
        RLMResults *sortedObjects = [unsortedObjects sortedResultsUsingProperty:@"date" ascending:NO];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [object.title stringByAppendingString:object.sectionTitle];
